...
## V3.2 Production Clean
- Removed Demo Pro / Demo Admin buttons from the public login page.
- Default DEMO_MODE is now false.
- Registration success screen tells users to verify email and check Inbox / Spam / Junk.
- No automatic redirect after registration, so users have time to verify their email.
- Login gives a clearer message when email verification is required.
